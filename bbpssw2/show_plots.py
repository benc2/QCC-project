...
plt.figure()
input_fidelities, probs099 = plot_probability_of_success_from_files(0.99, fit=True, **{'marker': "o", 'color': "red",
                                                                             'label': f"Gate fidelity 0.99"})
input_fidelities, probs100 = plot_probability_of_success_from_files(1, fit=True, **{'marker': "s", 'color': "blue",
...
input_fidelities, fractions099 = gate_fidelity_plot(0.9900000000000001, color="red")

input_fidelities, fractions100 = gate_fidelity_plot(1.0, color="blue")
...
plt.figure()
input_fidelities, probs099 = plot_probability_of_success_from_files(0.99,sample_size=200, fit=True, **{'marker': "o", 'color': "red",
                                                                             'label': f"Gate fidelity 0.99"})
input_fidelities, probs100 = plot_probability_of_success_from_files(1,sample_size=200, fit=True, **{'marker': "s", 'color': "blue",
                                                                                          'label': f"Gate fidelity 1"})
